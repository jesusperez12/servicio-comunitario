    ...
    <div class="col-xs-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h4 class="box-title">Edición de actividad</h4>
            </div>
            <div class="box-body">
                @include('common.errors')
                <form class="form-horizontal" id="form-new-report" name="form-new-report" method="POST" autocomplete="off">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    <input type="hidden" name="data_actividad" data-actividad="{{ $actividad }}">
                    <div class="row">
                                ...
                                <div class="col-sm-7 col-md-9 box-recurso-element">
                                    <div class="recurso-element">
                                        <div class="input-group">
                                            <input type="hidden" name="recurso_id[]">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="assignProvidersToActivityLabel">Actualizar prestador(es) de servicio de la actividad</h4>
      </div>
        ...
        <div class="row">
            <div class="col-xs-12">
                <form id="form-assign-providers" name="form-assign-providers" autocomplete="off">
                    ...
                    <input type="hidden" name="providers_unchecked" data-providers-unchecked="[]">
...
<script src="{{ URL::asset('assets/js/admin/report_edit.js') }}"></script>
@endsection