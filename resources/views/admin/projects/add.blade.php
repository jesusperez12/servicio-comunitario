...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" id="form-add-project" name="form-add-project" action="{{ url('admin/coordinador/project/add') }}" method="POST" autocomplete="off">
            {{ csrf_field() }}
            <!-- FORM PROYECTO -->
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <select id="autor" name="autor" type="text" class="form-control">
                                        @if(isset($users))
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="referencia">Referencia</label>
